...
soundManager.onready(function() {
  ...
  function fetchSoundcloudURL(track_id, callback) {
    ...
    loadScript('turntable/utils/soundcloud_fetch_url/?id=' + track_id, function(){});
  ...
  function loadSoundcloudID(track_id, oOptions) {
    ...
    if (typeof sc_cache[track_id] === 'undefined') {
      ...
      loadScript('turntable/utils/soundcloud_fetch_track/?id=' + track_id, function(){console.log('success')});
    } else {
